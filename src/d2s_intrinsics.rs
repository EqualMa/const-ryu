...
pub const fn div5(x: u64) -> u64 {
    x / 5
}

#[cfg_attr(feature = "no-panic", inline)]
pub const fn div10(x: u64) -> u64 {
    x / 10
}

#[cfg_attr(feature = "no-panic", inline)]
pub const fn div100(x: u64) -> u64 {
    x / 100
}
...
#[cfg_attr(feature = "no-panic", inline)]
pub const fn multiple_of_power_of_5(value: u64, p: u32) -> bool {
...
#[cfg_attr(feature = "no-panic", inline)]
pub const fn multiple_of_power_of_2(value: u64, p: u32) -> bool {
    debug_assert!(value != 0);
    debug_assert!(p < 64);
...
#[cfg_attr(feature = "no-panic", inline)]
pub const fn mul_shift_64(m: u64, mul: &(u64, u64), j: u32) -> u64 {
...
#[cfg_attr(feature = "no-panic", inline)]
pub const unsafe fn mul_shift_all_64(
    m: u64,
    mul: &(u64, u64),
    j: u32,
    vp: *mut u64,
